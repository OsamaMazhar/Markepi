...
Runs the same MarkepiCore pipeline as the Markepi app: EXIF, GPS, HDR gain
...
TEXT WATERMARK                 (applied when --text is given)
      --text <string>          The watermark text. EXIF tokens are substituted:
                               ...
                               {shutter_speed} {iso} {date} {time} {gps} {dimensions}
...
BORDER / WHITE FRAME           (applied when --border or any --border-* is given)
      ...
      --border-fields <list>   Comma-separated metadata fields printed in the
                               ...
                               (default: cameraModel,focalLength,aperture,
                                shutterSpeed,iso,dimensions,format,gps)
      ...
      --border-style <style>   classic | gallery | print | banner
                               (default: gallery)
  ...
  The frame is measured in millimetres, converted at --border-dpi:
      ...
      --border-caption-mm <0.5–20>
                               Caption text height. Follows --border-mm unless
                               given (default: 5.84 at an 8mm mat)
      --border-logo-mm <0.5–30>
                               Brand mark height, gallery and banner. Follows
                               --border-mm unless given (default: 13.6 at 8mm)
